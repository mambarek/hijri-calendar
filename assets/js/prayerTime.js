...
function createGrid(data, rowsPerPage){
    $("#jqGrid").jqGrid({
        ...
        colModel: [
            ...
            { label: 'Date', name: 'date', jsonmap: 'date.gregorian', formatter: dateFormatter, cellattr : formatNowCell, width: 150},
            { label: 'Hijri', name: 'hijri',jsonmap:'date.hijri', formatter: hijriFormatter, cellattr : formatNowCell, width: 200},
